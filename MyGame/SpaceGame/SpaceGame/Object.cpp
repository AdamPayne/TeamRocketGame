...
{
	this->posX = posX;
	getEntity2d()->setPosition(posX, getPosY(), 0);
}
...
{
	this->posY = posY;
	getEntity2d()->setPosition(getPosX(), posY, 0);
}
...
{
	this->scaleX = scaleX;
	getEntity2d()->setScale(scaleX, getScaleY());
}
...
{
	this->scaleY = scaleY;
	getEntity2d()->setScale(getScaleX(), scaleY);
}
